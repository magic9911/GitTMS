...
Public Class rptReservation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ticket_Management_System.rptReservation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReservation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReservation = New rptReservation()
        rpt.Site = Me.Site
        Return rpt
    End Function
