...
Public Class frmReservationRecord
    ...
    Sub GetData()
        Try
            ...
            Dim sqlquery = "SELECT * from view_reservation"
    ...
    Private Sub txtGuestName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtGuestName.TextChanged
        Try
            ...
            Dim MyAdapter As New MySqlDataAdapter
            Dim sqlquery = "SELECT * from view_reservation where GuestName like '" + txtGuestName.Text + "%' order by GuestName"
            Dim mycommand As New MySqlCommand()
            mycommand.Connection = Conn
            mycommand.CommandText = sqlquery
            MyAdapter.SelectCommand = mycommand
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim MyAdapter As New MySqlDataAdapter
            Dim sqlquery = "SELECT * from view_reservation WHERE date_time BETWEEN '" & date_start & "' AND '" & date_end & "'"
            Dim mycommand As New MySqlCommand()
            mycommand.Connection = Conn
            mycommand.CommandText = sqlquery
            MyAdapter.SelectCommand = mycommand
