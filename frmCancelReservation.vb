...
Imports System.Text
Public Class frmCancelReservation
...
date_txt & "','" & time_txt & "','" & txtReservationNo.Text & "','" & seat_no.Text & "','" & txtNotes.Text & "','" & User_Id & "','" & System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss", New System.Globalization.CultureInfo("th-TH")) & "')"
                If AddData(dr) Then
